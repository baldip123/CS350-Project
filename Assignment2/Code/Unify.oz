...
% Date  : Mon Sep 28 10:07:31 2015
% Modified from the code of Siddharth Agarwal
%==============

%=======================
% Changelog
%  1. Checks that the features are the same after sorting.
%     The features are still assumed to be numerals
%=======================
...
%========================
% A stop-gap substitute for FoldR
%========================
% declare FF
% fun {FF P Xs Partial}
%    case Xs
%    of nil then Partial
%    [] X|Xr then {P X {FF P Xr Partial}}
%    end
% end
